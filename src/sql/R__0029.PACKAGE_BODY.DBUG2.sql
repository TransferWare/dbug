  ...
  begin
    ...
    loop
      ...
      then
        ...
        p_depth := l_dynamic_depth - l_idx + 1; -- using standard approach, i.e. we start at depth 1 and go up as long as we keep on calling subprograms
        exit search_loop;
      end if;
