CREATE OR REPLACE PACKAGE "DBUG_CALL_STACK" authid definer
is
...
, p_size in naturaln default utl_call_stack.dynamic_depth -- This will skip the call to DBUG_CALL_STACK_PKG.GET_CALL_STACK() itself
)
