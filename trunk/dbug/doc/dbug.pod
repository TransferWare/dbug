...
semi-colon (;) and may not have spaces.
...
Time is given in milliseconds (value of 1000 is one second). Default is zero.
...
A line containing the address of dbug context, major version, minor version,
...
DBUG#I#<address of dbug context>#<major version>.<minor version>.<teeny version>#<name>#<context number>#<process id>#<flags>

=item DBUG_DONE, DBUG_DONE_CTX, dbug_done, dbug_done_ctx

A line containing the address of the dbug context, the maximum number of
functions on the stack and the stack usage will be printed.

This is the line printed: 

DBUG#D#<dbug context>#<maximum number of functions on the stack>#<stack usage>

=item DBUG_ENTER, DBUG_ENTER_CTX, dbug_enter, dbug_enter_ctx

A line consisting of the address of dbug context, file, function, line, level
and time (-1 if profiling is off else in milliseconds) is printed.

This is the line printed: 

DBUG#E#<address of dbug context>#<file>#<function>#<line>#<level>#<time>
...
DBUG#L#<address of dbug context>#<file>#<function>#<line>#<level>#<time>
...
DBUG#P#<address of dbug context>#<file>#<function>#<line>#<level>#<break point>#<user supplied parameters>
...
program uses standard input to create the report.
...
specified break points. A null list means all break points are enabled.
...
semi-colon separated list of debugger arguments.
