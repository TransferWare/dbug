...
A line containing 'DBUG', the address of dbug context, date (in GMT YYYYMMDDhhmmss
...
DBUG#<dbug context>#<date>#<seq>#I#<major version>.<minor version>.<teeny version>#<name>#<context number>#<process id>#<flags>

=item *

Output of DBUG_DONE, DBUG_DONE_CTX, dbug_done and dbug_done_ctx

A line containing 'DBUG', the address of the dbug context, date (in GMT YYYYMMDDhhmmss
format), a sequence number, 'D', the maximum number of
functions on the stack and the stack usage will be printed.

This is the line printed: 

DBUG#<dbug context>#<date>#<seq>#D#<maximum number of functions on the stack>#<stack usage>

=item *

Output of DBUG_ENTER, DBUG_ENTER_CTX, dbug_enter and dbug_enter_ctx

A line consisting of 'DBUG', the address of dbug context, date (in GMT YYYYMMDDhhmmss
format), a sequence number, 'E', file, function, line, level
and time (-1 if profiling is off else in milliseconds) is printed.

This is the line printed: 

DBUG#<address of dbug context>#<date>#<seq>#E#<file>#<function>#<line>#<level>#<time>
...
DBUG#<dbug context>#<date>#<seq>#L#<file>#<function>#<line>#<level>#<time>
...
DBUG#<dbug context>#<date>#<seq>#P#<file>#<function>#<line>#<level>#<break point>#<user supplied parameters>
